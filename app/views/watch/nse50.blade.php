...
<!--Load the AJAX API-->
    ...
    function drawGainerChart() {
      var jsonData = $.ajax({
          ...
          url: "http://localhost/market/public/call/json/nse50",
          dataType: "json",
          async: false
          }).responseText;
...
var options = {
      ...
      var chart1 = new google.visualization.LineChart(document.getElementById('chart_nse50'));
